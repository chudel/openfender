// from https://github.com/jiangts/JS-OTP with slight modifications
...
(function() {
  ...
  Hotp = (function() {
    ...
    Hotp.prototype.dec2hex = function(s) {
      return (s < 15.5 ? "0" : "") + Math.round(s).toString(16);
    };
...
// <chudel>  Did not work for counters > 127, so switched to text and prepended string and hex value of counter

    Hotp.prototype.getOtp = function(key, counter) {
      var digest, h, offset, shaObj, v;
      shaObj = new jsSHA("SHA-1", "HEX"); // was TEXT
      shaObj.setHMACKey(key, "HEX");
      counterString = ("0000000000000000" + counter.toString(16)).slice(-16);
